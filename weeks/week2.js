...
window.WEEK_DATA = {
  ...
  // NOTE: Week 2 沒有主題單字，feelings 留空會導致 Match / Quiz / Learn Gate 無法使用
  feelings: [],

  sightWords: [
    { word: 'over',   zh: '在…上方', sentence: 'Over the hill.' },
    { word: 'new',    zh: '新的',   sentence: 'I got a new book.' },
    { word: 'sound',  zh: '聲音',   sentence: 'What is a sound?' },
    { word: 'take',   zh: '拿',     sentence: 'Take it back.' },
    { word: 'only',   zh: '只有',   sentence: 'Only this can.' },
    { word: 'little', zh: '小的',   sentence: 'A little place.' },
    { word: 'work',   zh: '工作',   sentence: 'Back to work.' },
    { word: 'know',   zh: '知道',   sentence: 'I know you.' },
    { word: 'place',  zh: '地方',   sentence: 'A little place.' },
