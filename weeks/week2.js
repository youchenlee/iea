...
window.WEEK_DATA = {
  ...
  sightWords: [
    ...
    { word: 'hurt',     zh: '受傷',   sentence: 'He hurt his knee.' },
    { word: 'heart',    zh: '心臟',   sentence: 'I love you with all my heart.' },
    { word: 'far',      zh: '遠的',   sentence: 'It is far away.' },
    { word: 'farm',     zh: '農場',   sentence: 'He lived on a farm.' },
    { word: 'fast',     zh: '快速的', sentence: 'He can run very fast.' },
    { word: 'father',   zh: '父親',   sentence: 'My father is kind.' },
    { word: 'feet',     zh: '足',     sentence: 'Put your feet in the water.' },
    { word: 'find',     zh: '找到',   sentence: 'Can you find it?' },
    { word: 'fire',     zh: '火',     sentence: 'Be careful with fire.' },
    { word: 'fireman',  zh: '消防員', sentence: 'The fireman is brave.' },
    { word: 'first',    zh: '第一',   sentence: 'I came in first!' },
    { word: 'fish',     zh: '魚',     sentence: 'He loved to fish.' },
  ],
